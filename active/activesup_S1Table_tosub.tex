...
\centering
\caption{Parameter values sampled for individual figures}
\label{table:para2}
\begin{tabular}{|c|ccccccc|}
	\hline
	Parameter     & \textbf{Figure 3}          & \textbf{Figure 4}       & \textbf{Figure S3a,b}    & \textbf{Figure S3c,d}     & \textbf{Figure 7}    & \textbf{Figure 9}          \\ \hline
