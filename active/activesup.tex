...
\hline
{\bf parameter}             & {\bf range}          \\ \hline
extensional modulus         & $\mu_e$                                                  \\
compressional modulus             & $\mu_c$                             \\
cross-link drag coefficient & $\xi$              \\
medium drag coefficient     & $\zeta$          \\
filament length             & L                                                  \\
cross-link spacing          & $l_c$                                           \\
domain size                 & $D_x\times D_y$                                     \\ \hline
\end{tabular}
\end{table}
