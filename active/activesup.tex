...
\begin{equation}
\mathbf{\sigma} = \frac{(L-l_c)^2 \xi}{4\pi l_c^2} \dot \gamma 
\end{equation}
...
\begin{equation}
\label{lin_eqn}
\eta_{c} = \frac{(L-l_c)^2 \xi}{4\pi l_c^2} .
\end{equation}
...
\begin{tabular}{|c|ccccccc|}
	\hline
	Parameter     & \textbf{Figure 2}          & \textbf{Figure 3}       & \textbf{Figure 4}    & \textbf{Figure 5}  & \textbf{Figure 6}     & \textbf{Figure 7}    & \textbf{Figure 9}          \\ \hline
