...
\begin{flushleft}
{\Large
\textbf\newline{Filament Recycling and Sustained Contractile Flows in a 2D Active Network Model}
}
\newline
...
\paragraph{Further introductory detail about the components of the actin cortex and how they turn over}
...
\paragraph{Synopsis of mechanical picture and mentions of the few theoretical attempts to describe it}
