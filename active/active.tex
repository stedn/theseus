...
In long $\tau_r\gg\tau_c$ limit, this simplifies to $\eta_r=\eta_c$, while in the short $\tau_r\ll\tau_c$ limit, this simplifies to $\eta_r\sim\tau_r$, which matches qualitatively with our estimate as found in Figure \ref{fig:rec_form}.  This model presents a simple quantitative summary description of our simulation data.
