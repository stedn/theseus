...
\centering
\includegraphics[width=\hsize]{glass_relax}
\caption{\label{fig:strain_coll} A. Creep response of networks and filament extension for different filament compliances.  B. Variation from mean filament extension for the networks in A. }
\end{figure}
